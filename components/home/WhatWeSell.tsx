export const whatWeSellBottomColor = "#FDF2F8";

export default function WhatWeSell() {
  return (
    <section
      className="relative overflow-hidden px-6 pb-8 pt-16"
      style={{ backgroundImage: "linear-gradient(#ffffff, #FDF2F8)" }}
    >
      <div className="absolute top-0 right-0 -z-10 h-96 w-96 animate-pulse rounded-full bg-pink-100/40 blur-3xl duration-[6s]" />
      <div className="absolute bottom-24 left-0 -z-10 h-80 w-80 animate-pulse rounded-full bg-sky-100/30 blur-3xl duration-[8s]" />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-slate-600 font-medium text-sm sm:text-base leading-relaxed">
            We sell the best{" "}
            <span className="font-bold text-[#3C2A21]">POP painting kits</span>,
