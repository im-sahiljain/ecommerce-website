...
export default function ProductDetailView({
  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-7xl animate-pulse px-4 py-4 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
        <div className="grid grid-cols-1 gap-10 rounded-3xl border border-neutral-100 bg-white p-6 sm:p-10 md:grid-cols-2">
  ...
  if (!product) {
    return (
      <div className="mx-auto my-16 max-w-md rounded-3xl border border-neutral-100 bg-white p-8 text-center shadow-xs">
        <h3 className="text-lg font-bold text-neutral-800">Product Not Found</h3>
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
      <div className="soft-shadow relative grid grid-cols-1 gap-10 rounded-3xl border border-neutral-100 bg-white p-6 sm:p-10 md:grid-cols-2">
        <ProductGallery
          product={product}
