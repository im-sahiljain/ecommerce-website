...
Thank you! Please confirm my order and shipping fee.`;
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-neutral-950/60 backdrop-blur-xs">
      <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        {/* Modal Header */}
        <div className="bg-success-600 text-white p-5 flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-success-100 font-medium">
        ...
        >
          {/* Order Brief */}
          <div className="bg-success-50 border border-success-100 p-4 rounded-2xl text-xs space-y-1.5">
            <div className="flex justify-between font-bold text-success-900">
              <span>
            ...
            <div className="pt-1.5 border-t border-success-200/60 flex justify-between text-[11px] font-extrabold text-success-800">
              <span>Shipping Fee:</span>
              <span className="bg-success-200/60 px-2 py-0.5 rounded-md text-success-900">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-extrabold text-neutral-700 mb-1 flex items-center space-x-1">
                <User className="w-3.5 h-3.5 text-success-600" />
                <span>Full Name</span>
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-extrabold text-neutral-700 mb-1 flex items-center space-x-1">
                <MapPin className="w-3.5 h-3.5 text-success-600" />
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3.5 bg-success-600 hover:bg-success-700 text-white font-extrabold text-xs rounded-2xl shadow-lg transition flex items-center justify-center space-x-2 active:scale-98"
          >
