...
export const metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://ecommerce-website-pink-eight.vercel.app'),
  title: {
    default: 'POP Craft & Candle Store | Plaster Painting Kits for Kids & Aesthetic Soy Candles India',
    template: '%s | POP Craft & Candle Store',
  },
  description: 'Shop ready-to-paint plaster craft kits, DIY plaster figurines for kids birthday return gifts, and hand-poured non-toxic aesthetic soy wax candles in India.',
  keywords: [
  ...
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    url: 'https://ecommerce-website-pink-eight.vercel.app',
    siteName: 'POP Craft & Candle Store',
    title: 'POP Craft & Candle Store | Plaster Painting Kits for Kids & Aesthetic Soy Candles India',
    description: 'Discover non-toxic plaster painting kits for kids, birthday return gift boxes, and hand-poured aesthetic soy wax candles.',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'Shop non-toxic DIY plaster craft kits & aesthetic soy candles.',
