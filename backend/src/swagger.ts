...
const options: swaggerJSDoc.Options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Little Creators Craft Hub API',
      version: '1.0.0',
      description: 'Production REST API for Little Creators Craft Hub featuring Supabase PostgreSQL, Redis Caching, BullMQ Order Queueing, and Auth.',
      contact: {
        name: 'Little Creators Engineering',
      ...
      schemas: {
        Product: {
          ...
          properties: {
            ...
            image: { type: 'string', example: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab' },
            description: { type: 'string', example: 'Eco-friendly paint kit for young space explorers.' },
        ...
        Order: {
          ...
          properties: {
            ...
            shippingAddress: { type: 'string', example: '123 Main St, San Francisco, CA' },
            ...
            items: {
              ...
              items: {
                ...
                properties: {
                  ...
                  productName: { type: 'string', example: 'Space Rocket Painting Kit' },
                  price: { type: 'number', example: 29.99 },
            ...
            status: { type: 'string', example: 'Pending', enum: ['Pending', 'Processing', 'Shipped', 'Delivered'] },
        ...
        Category: {
          ...
          properties: {
            ...
            description: { type: 'string', example: 'Washable painting craft kits' },
          },
        },
        Theme: {
          type: 'object',
          properties: {
            ...
            description: { type: 'string', example: 'Outer space adventure crafts' },
          },
        },
        AgeGroup: {
          type: 'object',
    ...
    paths: {
      ...
      '/api/categories': {
        get: { summary: 'Get Categories List', tags: ['Categories'], responses: { 200: { description: 'List of categories' } } },
        post: { summary: 'Add Category', tags: ['Categories'], responses: { 201: { description: 'Category created' } } },
      },
      '/api/themes': {
        get: { summary: 'Get Themes List', tags: ['Themes'], responses: { 200: { description: 'List of themes' } } },
        post: { summary: 'Add Theme', tags: ['Themes'], responses: { 201: { description: 'Theme created' } } },
      },
      '/api/age-groups': {
        get: { summary: 'Get Age Groups List', tags: ['Age Groups'], responses: { 200: { description: 'List of age groups' } } },
        post: { summary: 'Add Age Group', tags: ['Age Groups'], responses: { 201: { description: 'Age group created' } } },
      },
      ...
      '/api/orders': {
        get: { summary: 'Get Orders (Admin / Search)', tags: ['Orders'], responses: { 200: { description: 'Orders list' } } },
        post: {
          ...
          responses: { 201: { description: 'Order created and queued asynchronously' } },
        },
      },
      ...
      '/api/admin/stats': {
        get: { summary: 'Get Admin Dashboard Statistics', tags: ['Admin'], responses: { 200: { description: 'Dashboard stats analytics' } } },
      },
    },
  },
  apis: ['./src/**/*.ts'],
